...
parser.add_argument('--project_dir', default='/path/to/THINGS-EEG2/', type=str)
...
for t in ["gamma", "beta", "raw"]:
    epoched_test, _, ch_names, times = epoching(args, 'test', t, seed)
    epoched_train, img_conditions_train, _, _ = epoching(args, 'train', t, seed)
